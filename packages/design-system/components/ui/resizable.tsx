...
const ResizableHandle = ({
  ...
  >
    {withHandle && (
      <div className="z-10 flex data-[panel-group-direction=vertical]:h-12 data-[panel-group-direction=vertical]:w-1 items-center justify-center rounded-sm border bg-border h-8 w-2">
